...
contract PreSale is Context, Ownable {
    ...
    */
    ...
    function _setMaxContribution(uint256 amount) private {
        require(msg.sender == owner());
        maxContribution = amount;
    }
    
    function _setMinContribution(uint256 amount) private {
        require(msg.sender == owner());
    ...
    function () external isFunding payable {
        ...
        // Added by Yuri //
        require(amount>=minContribution && amount<=maxContribution);
        // --- //
